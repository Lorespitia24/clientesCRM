package com.clientes.app.controller;
...
import com.clientes.app.services.IClienteService;
...
public class ClienteRestController {
	...
	@GetMapping("/clientes/tareas/list")
	public List<Tarea> getTareas() {
		return clienteService.findAllTarea();
	}
	
	@GetMapping("/clientes/origen")
	public List<Origen> origen() {
		return clienteService.getLisOrigen();
	}
	@GetMapping("/clientes/tipoContacto")
	public List<TipoContacto> tipoContacto() {
		return clienteService.getLisTipoContacto();
	}
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		try {
			...
			clienteActual.setTipoContacto(cliente.getTipoContacto());
			clienteActual.setOrigen(cliente.getOrigen());
	...
	//crear Tareas
	@PostMapping("/clientes/tareas/list")
	public ResponseEntity<?> crearTarea(@Valid @RequestBody Tarea tarea, BindingResult result) {
		...
		try {
			tareaNew = clienteService.saveTarea(tarea);
			System.out.println("----------->"+tareaNew.getTitulo().toString());
		} catch(DataAccessException e) {
			response.put("mensaje", "Error al realizar el insert en la base de datos");
			response.put("error", e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
